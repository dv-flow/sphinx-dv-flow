...
dvflow_root = os.path.join(_REPO, "tests", "data", "library")
exclude_patterns = ["_build"]

nitpicky = True

# `std` is a different distribution and this doc set does not document it. Said
# once, semantically, instead of as a regex in `nitpick_ignore`: a reference to
# anything in *this* project still fails the build.
